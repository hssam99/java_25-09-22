...
public class StudentController implements StudentProgram {
	...
	public int menuPrint(Scanner scan) {
		...
		System.out.println("1.학생등록|2.학생리스트|3.학생정보조회");
	...
	public boolean checkSubjectId(String keySubId) {
		for (Subject s : subList) {
	...
	public boolean checkStudentId(String tmpId) {
		// 중복된 학번 검사
...
//	}
	...
	public void insertSubject(Scanner sc) {
		...
		System.out.print("학번 >");
		int index = searchStudentID(sc.next()); // 학번 검사. 존재하지 않는 학번이면 -1 리턴
//		int index = stdList.indexOf(new Student(sc.next()));
