...
public class Account {
	...
	public void makeAccountFile()
		...
		bw.append("======= 계좌 정보 =======");
		bw.newLine();
		bw.append("은행: "+getBankName());
		bw.newLine();
		bw.append("계좌주명: "+getName());
		bw.newLine();
